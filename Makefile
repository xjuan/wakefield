...
FILES = wakefield-compositor.c wakefield-surface.c wakefield-data-device.c wakefield-compositor.h wakefield-private.h
...
libwakefield.so: wakefield-compositor.o wakefield-surface.o wakefield-data-device.o xdg-shell-server-protocol.h xdg-shell-protocol.o
	$(CC) $(CFLAGS) -o $@ wakefield-compositor.o wakefield-surface.o wakefield-data-device.o xdg-shell-protocol.o $(LDFLAGS)

CLEANFILES += libwakefield.so wakefield-compositor.o wakefield-surface.o wakefield-data-device.o xdg-shell-protocol.o
